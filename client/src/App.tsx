...
- **हीमोग्लोबिन (9.4 g/dL) [कम]:** हीमोग्लोबिन शरीर में ऑक्सीजन पहुंचाने वाली गाड़ी (डिलीवरी वैन) की तरह है। इसका मान कम होने पर मांसपेशियों और अंगों तक कम ऑक्सीजन पहुँचती है, जिससे दिनभर के सामान्य कामों में भी थकान या कमजोरी महसूस होना स्वाभाविक है।
- **श्वेत रक्त कोशिकाएं / WBC (13,800 /cu.mm) [अधिक]:** ये आपके शरीर की सुरक्षा सैनिक (डिफेंस टीम) हैं। इनकी संख्या अधिक होना यह दर्शाता है कि शरीर का इम्यून सिस्टम किसी सामान्य संक्रमण या सूजन से सक्रिय रूप से मुकाबला कर रहा है।
- **प्लेटलेट्स (265,000 /cu.mm) [सामान्य]:** आपके थक्का जमाने वाले सेल्स (नेचुरल रिपेयर बैंड-ऐड) बिलकुल सही और सुरक्षित स्तर पर हैं, जिससे रक्तस्राव का कोई जोखिम नहीं है।

### 3. डॉक्टर से परामर्श के लिए तैयारी (Next Steps)
- **ऊर्जा और थकान पर चर्चा (Energy Levels):** यदि आपको हाल ही में अधिक थकान, चक्कर या कमजोरी महसूस हुई है तो अपने डॉक्टर को अवश्य बताएं।
- **आयरन और पोषण की जांच (Nutrition Check):** डॉक्टर से पूछें कि क्या आपको आयरन युक्त आहार (जैसे पालक, दालें, चुकंदर) या सप्लीमेंट्स की आवश्यकता है।
- **अगली जांच का समय (Follow-Up Timeline):** संक्रमण ठीक होने के बाद 3-4 हफ़्तों में WBC और हीमोग्लोबिन दोबारा कब चेक कराना चाहिए, इस पर डॉक्टर का परामर्श लें।`,
  questionsEn: [
    {
...
- **Hydration & Dietary Modifications:** Work with a dietitian on low-glycemic meal planning.`,
  summaryHi: `### 1. रिपोर्ट का सारांश एवं आश्वस्ति (Overview & Reassurance)
यह मेटाबोलिक एवं रीनल प्रोफाइल आपके ब्लड शुगर और किडनी के फिल्टर की स्थिति का आंकलन करती है। आपके पोटेशियम और कैल्शियम जैसे महत्वपूर्ण मिनरल्स सामान्य स्तर पर हैं, जो दिल और नसों के लिए पूरी तरह सुरक्षित हैं। मुख्य ध्यान देने योग्य बात यह है कि ब्लड शुगर का स्तर बढ़ा हुआ है और किडनी पर थोड़ा अतिरिक्त काम पड़ रहा है।

### 2. महत्वपूर्ण निष्कर्ष सरल बोलचाल में (Key Findings)
- **फास्टिंग ग्लूकोज (168 mg/dL) एवं HbA1c (8.2%) [अधिक]:** शुगर शरीर की ऊर्जा का मुख्य ईंधन है। 8.2% का मतलब है कि पिछले 3 महीनों में शुगर का औसत स्तर थोड़ा ऊंचा रहा है, जिसे सही खान-पान और डॉक्टर की सलाह से नियंत्रित किया जा सकता है।
- **सीरम क्रिएटिनिन (1.45 mg/dL) एवं eGFR (54 mL/min) [किडनी तनाव]:** किडनी शरीर की प्राकृतिक छन्नी (वाटर फिल्टर) की तरह काम करती है। 54 eGFR बताता है कि फिल्टर की गति थोड़ी धीमी हुई है, जो अक्सर हाई शुगर के कारण होती है। इसे सुरक्षित रखना बहुत आसान है।
- **पोटेशियम एवं कैल्शियम [सामान्य]:** आपके दिल की धड़कन और हड्डियों के लिए जरूरी इलेक्ट्रोलाइट्स पूरी तरह संतुलित और सुरक्षित सीमा में हैं।

### 3. डॉक्टर से परामर्श के लिए तैयारी (Next Steps)
- **शुगर प्रबंधन पर चर्चा (Glucose Plan):** डॉक्टर से पूछें कि शुगर को सामान्य सीमा में लाने के लिए कौन सी दवा या जीवनशैली सबसे उपयुक्त है।
- **किडनी सुरक्षा के उपाय (Kidney Protection):** डॉक्टर से पानी की सही मात्रा और किडनी को सुरक्षित रखने वाली सावधानियों पर सलाह लें।
- **कम-मीठा और संतुलित आहार (Dietary Support):** मीठे पेय पदार्थों से बचें और साबुत अनाज व हरी सब्जियों को भोजन में शामिल करने की योजना बनाएं।`,
  questionsEn: [
    {
...
- **Follow-Up Interval:** Re-check your lipid panel in 3 to 6 months to evaluate lifestyle impact.`,
  summaryHi: `### 1. रिपोर्ट का सारांश एवं आश्वस्ति (Overview & Reassurance)
यह लिपिड प्रोफाइल आपके दिल और रक्त वाहिकाओं में वसा (कोलेस्ट्रॉल) की स्थिति को दर्शाती है। अच्छी बात यह है कि आपने समय पर जांच करवा ली है, जिससे किसी भी बड़ी समस्या से पहले ही खान-पान और हल्की कसरत से कोलेस्ट्रॉल को आसानी से सुधारा जा सकता है।

### 2. महत्वपूर्ण निष्कर्ष सरल बोलचाल में (Key Findings)
- **LDL खराब कोलेस्ट्रॉल (172 mg/dL) [अधिक]:** LDL रक्त वाहिकाओं में वसा पहुंचाने वाले ट्रकों की तरह है। इसका बढ़ा होना यह बताता है कि धमनियों में जमाव से बचने के लिए इसे कम करना फायदेमंद रहेगा।
- **HDL अच्छा कोलेस्ट्रॉल (36 mg/dL) [कम]:** HDL शरीर की सफाई गाड़ी (स्वीपर) है, जो धमनियों से फालतू वसा को साफ करती है। तेज वॉक या कसरत से इसे बढ़ाया जा सकता है।
- **hs-CRP सूजन मार्कर (3.8 mg/L) [अधिक]:** यह रक्त वाहिकाओं में हल्के तनाव या सूजन का संकेत देता है, जो जीवनशैली में सुधार से ठीक हो जाता है।

### 3. डॉक्टर से परामर्श के लिए तैयारी (Next Steps)
- **कोलेस्ट्रॉल कम करने की योजना (Lipid Management):** डॉक्टर से पूछें कि क्या आपको दवा की जरूरत है या सिर्फ आहार और वॉक से इसे ठीक किया जा सकता है।
- **स्वस्थ वसा और फाइबर (Dietary Fiber):** खाने में ओमेगा-3, अखरोट, अलसी और हरी पत्तेदार सब्जियों को शामिल करने पर चर्चा करें।
- **3 से 6 महीने में दोबारा जांच (Follow-Up Test):** जीवनशैली में बदलाव के असर को देखने के लिए अगली जांच की सही समय-सीमा तय करें।`,
  questionsEn: [
    {
...
export const App: React.FC = () => {
  ...
  return (
    <div lang={language} className={`min-h-screen bg-[#060913] text-slate-100 flex flex-row selection:bg-teal-500 selection:text-slate-950 ${language === 'hi' ? 'lang-hi' : ''}`}>
